...
public class Client {
    ...
    public void testConnection () { //метод для тестирования соединения
        ...
        InputStreamReader isReader; //ссылка на экземпляр класса для чтения потока данных из сокета
            ...
            String request = "simple-bank-system;" + "user1" + ";" + Helper.makeMD5("password1") + ";password changing"; //собираем строку запроса на сервер
            System.out.println("request " + request); //выводим строку запроса в консоль
            String encryptedRequest = Helper.encrypt(request); //шифруем строку запроса на сервер
